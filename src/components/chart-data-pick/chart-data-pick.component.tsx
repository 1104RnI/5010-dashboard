import { ChartDataPickContainer, DataContainer } from './chart-data-pick.styles'
...
export default function ChartDataPick(props: ChartDataPickProps) {
	const { average, highest, lowest, scale, isDaytime } = props

	return (
		<ChartDataPickContainer>
			{isDaytime ? <h5>Daytime(09:00 ~ 18:00)</h5> : <h5>Fulltime(24h)</h5>}
			<DataContainer>
				{average ? (
					<li id="average-data">
						average
